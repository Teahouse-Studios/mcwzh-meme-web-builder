<template>
  <v-footer
    :color="$vuetify.theme.dark ? '#1E1E1E' : '#323437'"
    dark
    elevation="6"
    class="pb-16"
  >
    <v-container>
      ...
      <div class="text-right body-2 mt-2" v-if="beianWd">
        <a
      ...
      <div class="text-right body-2 mt-2" v-if="beianTh">
        <a
          class="white--text text-decoration-none"
          href="https://beian.miit.gov.cn/"
        >
...
export default {
  ...
  data: () => ({
    ...
    mdiLock,
    mdiScript,
    beianWd: window.location.host === 'meme.wd-ljt.com',
    beianTh:
